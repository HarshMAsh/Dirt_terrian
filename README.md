...
<img width="911" height="658" alt="image" src="https://github.com/user-attachments/assets/8ec9eacc-bb78-4e3b-8c62-fa41988b5041" />
...
1. Clone the repository to your local machine:
   ...
   ```bash
   git clone https://github.com/HarshMAsh/E-Commerce-Website.git
   ```
